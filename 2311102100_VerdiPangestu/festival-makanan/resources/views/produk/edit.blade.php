...
<style>
    ...
    /* Aksen Gradien Atas (Warna Biru/Primary untuk penanda mode Edit) */
    .form-card::before {
        content: '';
        position: absolute;
        top: 0;
        ...
        <div class="form-card p-4 p-md-5">
            ...
            <div class="text-center mb-5">
                <div class="bg-light rounded-circle d-inline-flex align-items-center justify-content-center mb-3" style="width: 64px; height: 64px;">
                    <i class="bi bi-pencil-square fs-2" style="color: #2980b9;"></i>
                </div>
                <h3 class="fw-bold mb-1" style="color: #2c3e50; letter-spacing: -0.5px;">Edit Data Produk</h3>
                <p class="text-muted small">Perbarui informasi produk <strong>{{ $produk->nama_produk }}</strong></p>
            </div>
            ...
            @if($errors->any())
                <div class="alert alert-error-custom d-flex mb-4 p-3">
                    ...
                    <div>
                        <span class="fw-bold">Gagal memperbarui data!</span>
            ...
            <form action="/produk/{{ $produk->id }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="input-group">
                            ...
                            <select name="kategori" class="form-select with-icon" required>
                                ...
                                <option value="Dessert" {{ old('kategori', $produk->kategori) == 'Dessert' ? 'selected' : '' }}>Dessert</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="deskripsi" class="form-control"
                              rows="4" required>{{ old('deskripsi', $produk->deskripsi) }}</textarea>
                </div>

                {{-- Row 4: Upload Gambar dengan Preview Saat Ini --}}
                <div class="mb-4">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        @if($produk->gambar)
                            <div class="me-3 text-center">
                                <img src="{{ asset('storage/' . $produk->gambar) }}" alt="Preview" class="current-image-preview mb-1">
                                <div class="small text-muted" style="font-size: 0.7rem;">Saat Ini</div>
                            </div>
                        @endif
                    ...
                    <div class="form-text small text-muted"><i class="bi bi-info-circle me-1"></i>Abaikan (jangan upload file) jika tidak ingin mengubah gambar saat ini.</div>
                </div>
