...
<body>
    ...
    <nav class="navbar" id="top">
        ...
        <ul class="nav-links">
            ...
            <li><a href="{{ route('products.create') }}" class="nav-cta">+ Tambah Menu</a></li>
        </ul>
    </nav>
    ...
    <section class="products-section" id="menu">
        <div class="section-header">
            ...
            <a href="{{ route('products.create') }}" class="btn-primary" style="font-size:0.9rem; padding: 0.75rem 1.8rem;">
                + Tambah Produk Baru
            </a>
        </div>
        ...
        <div class="product-grid">
            ...
            <div class="product-card">
                <div class="card-image-wrap">
                    ...
                    <span class="card-rating">⭐ {{ number_format($product->rating, 1) }}</span>
                </div>
                <div class="card-body">
                    ...
                    <div class="card-footer">
                        <div>
                            ...
                            <span class="card-stock">Stok: {{ $product->stock }} porsi</span>
                        </div>
            ...
            <div class="empty-state">
                ...
                <a href="{{ route('products.create') }}" class="btn-primary">+ Tambah Menu Pertama</a>
            </div>
            @endforelse
        </div>
    </section>
    ...
    <footer>
        ...
        <div class="footer-links">
            ...
            <a href="{{ route('products.create') }}">Tambah Menu</a>
        </div>
