...
<head>
    ...
    <title>Edit Produk - Mas Jakobi</title>
    ...
    <style>
        ...
        .card-header-gradient {
            /* Menyesuaikan dengan gradient Hijau-Kuning di Dashboard Mas Jakobi */
            background: linear-gradient(90deg, #b8e92d 0%, #f7e61c 100%);
            padding: 40px;
            text-align: center;
            color: #2d3436; /* Warna teks gelap agar kontras dengan kuning */
        }
        ...
        .form-control:focus {
            box-shadow: 0 0 0 4px rgba(184, 233, 45, 0.2);
            border-color: #b8e92d;
        }
        ...
        .btn-update:hover {
            ...
            box-shadow: 0 8px 20px rgba(184, 233, 45, 0.4);
            opacity: 0.9;
        }
...
<body>
    ...
    <div class="card-container animate__animated animate__fadeInUp">
        <div class="card-header-gradient">
            ...
            <p class="mb-0 fw-semibold opacity-75">Perbarui Informasi Menu Mas Jakobi</p>
        </div>
            ...
            <form action="{{ route('products.update', $product->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        <label class="form-label"><i class="bi bi-pencil-square me-1"></i> Nama Produk</label>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <input type="text" name="gambar" class="form-control" value="{{ $product->gambar }}">
                        <div class="mt-2">
                             <small class="preview-text small italic">*Pastikan URL gambar valid agar tampil di dashboard</small>
                        </div>
                    </div>

                    <div class="col-12 mb-4">
                        <label class="form-label"><i class="bi bi-info-circle me-1"></i> Deskripsi Produk</label>
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-update">
                        <i class="bi bi-arrow-repeat me-2"></i> Perbarui Data Menu
                    </button>
