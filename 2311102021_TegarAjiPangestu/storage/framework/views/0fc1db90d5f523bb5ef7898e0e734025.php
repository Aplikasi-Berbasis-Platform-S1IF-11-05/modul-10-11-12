    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow">
                ...
                <?php if($p->image): ?>
                    <img src="/images/<?php echo e($p->image); ?>" class="product-img">
                <?php else: ?>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="price">Rp <?php echo e(number_format($p->price)); ?></span>
                    </div>

                    <p class="text-muted mt-2"><?php echo e($p->description); ?></p>

                    <div class="d-flex justify-content-end mt-3">
                        <a href="/delete/<?php echo e($p->id); ?>"
...
</html><?php /**PATH E:\SEMESTER6\praktikum\modul10\2311102021_TegarAjiPangestu\FestivalMakanan\resources\views/home.blade.php ENDPATH**/ ?>