...
<body>
    <nav class="navbar">
        ...
        <div class="nav-links">
            ...
            <a href="{{ route('products.create') }}" style="color: var(--primary); font-weight: 700;">+ Tambah Menu</a>
        </div>
    </nav>
    ...
    <section class="container" id="products">
        <div class="section-title">
            ...
            <div style="margin-top: 2rem;">
                <a href="{{ route('products.create') }}" class="cta-button" style="background: var(--secondary); color: white; padding: 0.8rem 1.5rem; font-size: 1rem;">+ Tambah Produk Baru</a>
            </div>
        </div>
