...
<style>
    ...
    .btn-submit { background:var(--red); color:white; border:none; padding:12px 32px; border-radius:8px; font-size:14px; font-weight:700; cursor:pointer; margin-right:.75rem; }
    ...
    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" name="name" value="{{ old('name') }}" placeholder="cth: Nasi Pecel Spesial" required>
            </div>
            <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea name="description" placeholder="Ceritakan keistimewaan produk ini..." required>{{ old('description') }}</textarea>
        </div>
        <div class="form-row">
            <div class="form-group">
                <label>Harga (Rp)</label>
                <input type="number" name="price" value="{{ old('price') }}" min="0" placeholder="25000" required>
            </div>
            <div class="form-group">
                <label>Porsi</label>
                <input type="text" name="portion" value="{{ old('portion') }}" placeholder="cth: 1 porsi, 200gr">
            </div>
        </div>
        <div class="form-row">
            <div class="form-group">
        ...
        <div class="form-group">
            <label>Gambar — atau Pakai URL Online</label>
            <input type="url" name="image_url" value="{{ old('image_url') }}" placeholder="https://images.unsplash.com/...">
            <p class="hint">Jika upload dan URL diisi, upload file yang digunakan.</p>
        </div>
        <div class="form-group">
