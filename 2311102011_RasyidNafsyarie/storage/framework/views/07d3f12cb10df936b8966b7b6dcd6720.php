...
<head>
    ...
    <title>Tentang — <?php echo e(config('app.name')); ?></title>
...
<body class="font-sans antialiased bg-amber-50 text-stone-900 min-h-screen flex flex-col">
    ...
    <main class="flex-1">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
            ...
            <div class="mt-10">
                <a href="<?php echo e(route('products.index')); ?>" class="inline-flex rounded-lg bg-amber-600 px-5 py-2.5 text-white font-semibold hover:bg-amber-700">Jelajahi katalog</a>
            </div>
        </div>
    </main>
...
<?php /**PATH D:\Master\Telkom University Purwokerto\Semester 6\Aplikasi Berbasis Platform\Praktikum\Modul11-13\2311102011_RasyidNafsyarie\resources\views/about.blade.php ENDPATH**/ ?>